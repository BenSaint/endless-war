...
weapon_list = [
	EwWeapon( # 1
		...
		str_weaponmaster_self="You are a rank {} master of the dual pistols.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} master of the dual pistols.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 2
		...
		str_weaponmaster_self="You are a rank {} master of the assault rifle.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} master of the assault rifle.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 3
		...
		str_weaponmaster_self="You are a rank {} kung-fu master.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} kung-fu master.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 4
		...
		str_weaponmaster_self="You are a rank {} blademaster.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} blademaster.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 5
		...
		str_weaponmaster_self="You are a rank {} master of the nailbat.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} master of the nailbat.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 6
		...
		str_weaponmaster_self="You are a rank {} master of the garrotte.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} master of the garrotte.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 7
		...
		str_weaponmaster_self="You are a rank {} master pugilist.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} master pugilist.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 8
		...
		str_weaponmaster_self="You are a rank {} master arsonist.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} master arsonist.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 9
		...
		str_weaponmaster_self="You are a rank {} master of the throwing knife.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} master of the throwing knife.".format(user_data.weaponskill-4),
	...
	EwWeapon( # 10
		...
		str_weaponmaster_self="You are a rank {} master of the scythe.".format(user_data.weaponskill-4),
		str_weaponmaster="They are a rank {} master of the scythe.".format(user_data.weaponskill-4),
